...
#SBATCH --output=.slurm/latxa-7b-v1.1_eng_first500step_cntd_noeng.out
#SBATCH --error=.slurm/latxa-7b-v1.1_eng_first500step_cntd_noeng.err
#SBATCH --exclusive
#SBATCH --requeue
...
SAVE_PATH=/leonardo_scratch/large/userexternal/amohamed/Llama-2-7b-neox-eus-latxa-7b-v1.1_eng_first500step_cntd_noeng
if [ -d "$SAVE_PATH" ]; then
    LOAD_PATH=$SAVE_PATH
    FINETUNE="false"
    CONF_NAME="continue"
